...
def read_song_npy(filename):
    ...
    if len(np.shape(raw_audio)) > 1:        # Change #1: by Remya S. "If" condition introduced because when shape is (M,), unnecessary transformations were being done. Not tested for (M,1) case
